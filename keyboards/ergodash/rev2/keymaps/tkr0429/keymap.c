...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( 
    ...
    MO(_SYMB), KC_LGUI, KC_LALT, KC_LGUI, M_EMHL,   KC_SPC  ,KC_SPC,                  KC_ENT,KC_ENT ,  M_KHKR,            KC_LEFT, KC_UP,   KC_DOWN,   KC_RGHT  \
  ),
  ...
  [_SYMB] = LAYOUT( 
    ...
    KC_TRNS, KC_TRNS, KC_MS_U, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, JP_YEN,  \
    KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS, KC_TRNS,                        KC_DEL,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  \
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                        KC_TRNS, KC_TRNS, KC__MUTE, KC_MRWD, KC_MFFD, KC_TRNS, KC_TRNS,  \
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LGUI,  LOWER,   KC_SPC,  KC_SPC,                        KC_ENT,  KC_ENT,  RAISE,   KC_HOME, KC_PGUP, KC_PGDN, KC_END   \
  ),
